...
**Endpoint:** `https://mcp.ansvar.eu/law-lu/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add luxembourg-law --transport http https://mcp.ansvar.eu/law-lu/mcp` |
...
```json
{
  "mcpServers": {
    "luxembourg-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-lu/mcp"
    }
  }
}
```
