...
- **Socket.dev**: Supply chain attack detection on pull requests
...
- **Trivy**: Filesystem, dependency, and container vulnerability scanning
...
- Automated security testing in CI/CD (6-layer scanning)
...
- Source data from official Legilux portal (https://legilux.public.lu) — auditable
