...
export const TOOLS: Tool[] = [
  {
    ...
    description: 'Search Luxembourg statutes and regulations by keyword. Uses FTS5 with BM25 ranking.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'get_provision',
    description: 'Retrieve a specific provision (section) from a Luxembourg statute.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Build a comprehensive set of citations for a legal question across Luxembourg statutes.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'check_currency',
    description: 'Check if a Luxembourg statute or provision is currently in force.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Statute identifier or title' },
  ...
  {
    name: 'get_eu_basis',
    description: 'Get EU legal basis (directives/regulations) for a Luxembourg statute or retained EU law.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Luxembourg statute identifier' },
  ...
  },
  {
    ...
    description: 'Find Luxembourg statutes implementing a specific EU directive or regulation.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Get EU legal basis for a specific provision within a Luxembourg statute.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Luxembourg statute identifier' },
  ...
  },
  {
    ...
    description: 'Validate EU compliance status for a Luxembourg statute or provision.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Luxembourg statute identifier' },
